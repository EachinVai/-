...
module.exports.handleEvent = async function({ api, event, args, Threads, Users }) {
  ...
  if ((event.body.toLowerCase() == "ullash") || (event.body.toLowerCase() == "Ullash bai") || (event.body.toLowerCase() == "@EACHIN──😘😈🩶🪽 ッ") || (event.body.toLowerCase() == "Eachin")) {
  ...
  if ((event.body.toLowerCase() == "@MD Shiam Tafeder ") || (event.body.toLowerCase() == "লিওন")) {
   ...
   if ((event.body.toLowerCase() == "gf") || (event.body.toLowerCase() == "bf")) {
     return api.sendMessage("খালি কি তোরাই পেম করবি আমার ইয়াছিন বসের জন্য গফ দে<🥺", threadID);
   };
